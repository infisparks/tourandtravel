...
export default function Page() {
                    ...
                    <div className="banner-wrapper">
                        <div className="banner-video-area">
                            <video autoPlay loop muted playsInline
                                src="/media/home2-banner-video.mp4"></video>
                        </div>
    ...
    <div className="filter-wrapper">
        <div className="container">
            <ul className="filter-item-list">
                ...
                <li className="single-item hotel">
                    <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div className="filter-input-wrap">
                ...
                <form className="filter-input two">
                    ...
                    <div className="single-search-box date-field">
                        ...
                        <div className="custom-select-dropdown">
                            <input type="text" name="daterange" className="hotel-checkin" readOnly
                                value="June 16 - June 20" />
                            <div className="hotel-selected-date-checkin"></div>
                        </div>
                    </div>
                    <div className="single-search-box date-field">
                        <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="custom-select-dropdown">
                            <input type="text" name="daterange" className="hotel-checkin" readOnly
                                value="June 16 - June 20" />
                            <div className="hotel-selected-date-checkout"></div>
                        </div>
                    </div>
                                    ...
                                    <ul className="guest-count">
                                        <li className="single-item">
                                            ...
                                            <div className="quantity-counter">
                                                <a href="#" data-type="adult" className="guest-quantity__minus"><i
                                                        className="bi bi-dash"></i></a>
                                                <input name="adult_quantity" type="text" className="quantity__input"
                                                    value="1" />
                                                <a href="#" data-type="adult" className="guest-quantity__plus"><i
                                        ...
                                        <li className="single-item">
                                            ...
                                            <div className="quantity-counter">
                                                <a href="#" data-type="child" className="guest-quantity__minus"><i
                                                        className="bi bi-dash"></i></a>
                                                <input name="child_quantity" type="text" className="quantity__input"
                                                    value="0" />
                                                <a href="#" data-type="child" className="guest-quantity__plus"><i
                                                        className="bi bi-plus"></i></a>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <button type="button" className="primary-btn1 two add-btn">
                                <span>
                                    <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 4H10V6H6V10H4V6H0V4H4V0H6V4Z"></path>
                                    </svg>
                                    Add Another Room
                                </span>
                                <span>
                        ...
                        <div className="custom-select-wrap">
                            ...
                            <ul className="option-list visa-list">
                                <li>
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-bd-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-indo-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-nepal-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-india-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-brazil-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-thailand-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-spain-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-uae-flag.png" alt="" />
                                    </div>
                                </li>
                                <li>
                                    <div className="destination">
                                    ...
                                    <div className="flag">
                                        <img src="/images/filter-usa-flag.png" alt="" />
                                    </div>
                                </li>
                            </ul>
                        </div>
    ...
    <div className="home2-package-slider-section mb-100">
        <div className="container">
            <div className="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                <div className="package-card">
                                    ...
                                    <div className="package-content">
                                        <h5><a href="travel-package-details.html">Mystic Mountains Retreat</a></h5>
                                        <div className="location-and-time">
                                            <div className="location">
                                                ...
                                                <a href="travel-package-01.html">Himachal Pradesh, India</a>
                                            </div>
                                            <svg className="arrow" width="25" height="6" viewBox="0 0 25 6"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <svg className="divider" height="6" viewBox="0 0 374 6"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <div className="package-img-wrap">
                                        <div className="swiper package-card-img-slider">
                                            <div className="swiper-wrapper">
                                                <div className="swiper-slide">
                                                    <a href="travel-package-details.html" className="package-img">
                                                        <img src="/images/tour-package-img2_1.jpg" alt="" />
                                                    </a>
                                                </div>
                                                <div className="swiper-slide">
                                                    <a href="travel-package-details.html" className="package-img">
                            ...
                            <div className="swiper-slide">
                                <div className="package-card">
                                    ...
                                    <div className="package-content">
                                        <h5><a href="travel-package-details.html">Backwaters & Beaches</a></h5>
                                        <div className="location-and-time">
                                            <div className="location">
                                                <svg width="14" height="14" viewBox="0 0 14 14"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a href="travel-package-01.html">Kerala, India</a>
                                            </div>
                                            <svg className="arrow" width="25" height="6" viewBox="0 0 25 6"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div className="package-content">
                                        ...
                                        <div className="location-and-time">
                                            <div className="location">
                                                ...
                                                <a href="travel-package-01.html">Europe</a>
                                            </div>
                                            <svg className="arrow" width="25" height="6" viewBox="0 0 25 6"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
        ...
        <img src="/images/home2-package-slider-vector1.svg" alt="" className="vector1" />
        <img src="/images/home2-package-slider-vector2.svg" alt="" className="vector2" />
        <img src="/images/home2-package-slider-vector3.svg" alt="" className="vector3" />
    </div>
    ...
    <div className="home2-service-section mb-100">
        <div className="container">
            <div className="service-wrapper two">
                <div className="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                ...
                <div className="bottom-area d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                    <div className="batch">
    ...
    <div className="home2-destination-section mb-100">
        <div className="container">
            <div className="section-title text-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                data-wow-duration="1500ms">
                ...
                <div className="swiper home2-destination-slider">
                    <div className="swiper-wrapper">
                        <div className="swiper-slide">
                            <div className="destination-card2">
                                <a href="destination-details.html" className="destination-img">
                                    <img src="/images/destination-img1.jpg" alt="" />
                                </a>
                        ...
                        <div className="swiper-slide">
                            <div className="destination-card2">
                                <a href="destination-details.html" className="destination-img">
                                    <img src="/images/destination-img2.jpg" alt="" />
                                </a>
                                <div className="destination-content">
                        ...
                        <div className="swiper-slide">
                            <div className="destination-card2">
                                <a href="destination-details.html" className="destination-img">
                                    <img src="/images/destination-img4.jpg" alt="" />
                                </a>
                                <div className="destination-content">
                        ...
                        <div className="swiper-slide">
                            <div className="destination-card2">
                                <a href="destination-details.html" className="destination-img">
                                    <img src="/images/destination-img5.jpg" alt="" />
                                </a>
                                <div className="destination-content">
                        ...
                        <div className="swiper-slide">
                            <div className="destination-card2">
                                <a href="destination-details.html" className="destination-img">
                                    <img src="/images/destination-img6.jpg" alt="" />
                                </a>
                                <div className="destination-content">
                        ...
                        <div className="swiper-slide">
                            <div className="destination-card2">
                                <a href="destination-details.html" className="destination-img">
                                    <img src="/images/destination-img7.jpg" alt="" />
                                </a>
                                <div className="destination-content">
                ...
                <div className="slider-btn-grp two">
                    ...
                    <div className="slider-btn destination-slider-next">
                        <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <path fillRule="evenodd" clipRule="evenodd"
                                    d="M16 7.31421H-3.8147e-06V8.68564H16V7.31421Z"></path>
                                <path fillRule="evenodd" clipRule="evenodd"
    ...
    <div className="home2-about-section mb-100">
        <div className="container">
            <div className="row mb-60">
                ...
                <div className="col-lg-6 d-lg-block d-none wow animate fadeInRight" data-wow-delay="200ms"
                    data-wow-duration="1500ms">
                    <div className="about-img-wrap">
                        <div className="row align-items-end g-xl-4 g-lg-2 g-4">
            ...
            <div className="service-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <div
                    ...
                    <div className="col">
                        <div className="single-service">
                            <a href="experience-grid.html">
                                <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" clipRule="evenodd"
                                        d="M15 27.5C4.70625 27.5 2.5 25.2938 2.5 15C2.5 4.70625 4.70625 2.5 15 2.5C25.2938 2.5 27.5 4.70625 27.5 15C27.5 25.2938 25.2938 27.5 15 27.5ZM18.5169 9.28965C18.4254 9.12316 18.29 8.98488 18.1256 8.88977C17.9611 8.79467 17.7737 8.74636 17.5838 8.75009C17.3938 8.75382 17.2085 8.80943 17.0479 8.91091C16.8873 9.0124 16.7575 9.15588 16.6726 9.32583L12.352 17.967L10.444 14.498C10.3542 14.3346 10.222 14.1983 10.0615 14.1034C9.90093 14.0084 9.71782 13.9583 9.5313 13.9584H7.7084C7.13311 13.9584 6.66675 14.4247 6.66675 15C6.66675 15.5753 7.13311 16.0417 7.7084 16.0417H8.91543L11.4832 20.7103C11.5748 20.8768 11.7101 21.015 11.8746 21.1101C12.0391 21.2052 12.2264 21.2535 12.4164 21.2498C12.6063 21.2461 12.7916 21.1905 12.9522 21.089C13.1128 20.9876 13.2427 20.8441 13.3276 20.6742L17.6482 12.0331L19.5561 15.502C19.646 15.6654 19.7781 15.8018 19.9386 15.8967C20.0992 15.9916 20.2823 16.0417 20.4688 16.0417H22.2917C22.867 16.0417 23.3334 15.5753 23.3334 15.0001C23.3334 14.4248 22.867 13.9584 22.2917 13.9584H21.0847L18.5169 9.28965Z">
                                    </path>
                                </svg>
                                Tour <br /> Experineces
                            </a>
            ...
            <div className="rating-area wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                ...
                <div className="text-and-logo">
                    ...
                    <a href="http://trustpilot.com/"><img src="/images/trustpilot-logo_1.svg" alt="" /></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div className="home2-oneday-trip-section mb-100">
        <div className="container">
                        ...
                        <div className="package-img-wrap">
                            <div className="swiper package-card-img-slider">
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img19.jpg" alt="" />
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img20.jpg" alt="" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div className="info">
                                            ...
                                            <div className="tooltip-text">Including Activities <span>Scuba Diving,
                                    ...
                                    <li>
                                        ...
                                        <div className="info">
                                            ...
                                            <div className="tooltip-text">This package covers <span>Accommodation, Daily
                                                    Meals, Entry Fees & Local Transfers</span> to ensure a worry-free
                                                trip.</div>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div className="package-img-wrap">
                            <div className="swiper package-card-img-slider">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img12.jpg" alt="" />
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img21.jpg" alt="" />
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img22.jpg" alt="" />
                                        </a>
                                    </div>
                                </div>
                            </div>
            ...
            <div className="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="col-lg-12 d-flex justify-content-center">
                    <a href="travel-package-01.html" className="primary-btn1 transparent">
                        <span>
                            View All Trips
                            <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path
        ...
        <div className="container">
            <div className="offer-banner-wrap">
                ...
                <div className="offer-banner-img">
                    <img src="/images/home2-offer-banner-img.png" alt="" />
                </div>
                <img src="/images/offer-banner-vector1.svg" alt="" className="vector1" />
                <img src="/images/offer-banner-vector2.svg" alt="" className="vector2" />
            </div>
        </div>
        <img src="/images/home2-offer-banner-vector.svg" alt="" className="vector" />
    </div>
            ...
            <div className="row gy-md-5 gy-4">
                        ...
                        <div className="package-img-wrap">
                            <div className="swiper package-card-img-slider">
                                <div className="swiper-wrapper">
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img7.jpg" alt="" />
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img17.jpg" alt="" />
                                        </a>
                                    </div>
                                    <div className="swiper-slide">
                                        <a href="travel-package-details.html" className="package-img">
                                            <img src="/images/tour-package-img18.jpg" alt="" />
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="package-card">
                        <div className="package-img-wrap">
                            <a href="travel-package-details.html" className="package-img">
                                <img src="/images/tour-package-img8.jpg" alt="" />
                            </a>
                            <div className="batch">
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="package-card">
                        <div className="package-img-wrap">
                            <a href="travel-package-details.html" className="package-img">
                                <img src="/images/tour-package-img9.jpg" alt="" />
                            </a>
                            <div className="batch">
    ...
    <div className="home2-award-banner-section mb-100"
        style={{/* fix manual */}}>
        <div className="container">
            <div className="banner-content">
                <div className="award-rating-area">
                    <img src="/images/travel-award.png" alt="" />
                ...
                <span className="vector two"></span>
            </div>
        </div>
    </div>
            ...
            <div className="partner-wrap">
                <div className="marquee">
                    <div className="marquee__group">
                        <a href="#"><img src="/images/partner-01.png" alt="" /></a>
                        <a href="#"><img src="/images/partner-02.png" alt="" /></a>
                        <a href="#"><img src="/images/partner-03.png" alt="" /></a>
                        <a href="#"><img src="/images/partner-04.png" alt="" /></a>
                        <a href="#"><img src="/images/partner-05.png" alt="" /></a>
                        <a href="#"><img src="/images/partner-06.png" alt="" /></a>
                    </div>
    ...
    <div className="home2-blog-section mb-100">
        <div className="container">
            <div className="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms"
                data-wow-duration="1500ms">
                <div className="col-xl-6 col-lg-8">
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="blog-card2">
                        <div className="blog-img-wrap">
                            ...
                            <a href="travel-inspiration-01.html" className="blog-date">
                                02 <span>Jan.</span>
                            </a>
                        </div>
                        <div className="blog-content">
                            ...
                            <h4><a href="travel-inspiration-details.html">Nature, Culture & Thrill: Travel Stories That
                                    Inspire.</a></h4>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="blog-card2">
                        ...
                        <div className="blog-content">
                            ...
                            <h4><a href="travel-inspiration-details.html">Top 10 Beaches to Visit This Summer
                                    Season.</a></h4>
                        </div>
                    </div>
                </div>
            ...
            <div className="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="col-lg-12 d-flex justify-content-center">
                    <a href="travel-inspiration-01.html" className="primary-btn1 transparent">
                        <span>
                        ...
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                <div className="testimonial-card three">
                                    ...
                                    <p>Our honeymoon package to the Maldives was beyond amazing! The travel agency took
                                        care of every detail.</p>
                                    <div className="author-area">
                                        <div className="author-img">
                                            <img src="/images/testimonial-author-img1.png" alt="" />
                                        </div>
                            ...
                            <div className="swiper-slide">
                                <div className="testimonial-card three">
                                    ...
                                    <p>The Thailand tour was flawless! Great hotels, smooth transfers — truly a
                                        stress-free and enjoyable experience.</p>
                                    <div className="author-area">
                                        <div className="author-img">
                                            <img src="/images/testimonial-author-img3.png" alt="" />
                                        </div>
                                        <div className="author-info">
                                            <h5>James Bonde</h5>
                                            <span>GoFly Traveler</span>
                            ...
                            <div className="swiper-slide">
                                <div className="testimonial-card three">
                                    ...
                                    <p>Thanks to their expert planning, our Dubai vacation was seamless. Every detail
                                        was handled with care.</p>
                                    <div className="author-area">
                                        <div className="author-img">
                                            <img src="/images/testimonial-author-img2.png" alt="" />
                                        </div>
                                        <div className="author-info">
                                            <h5>Selina Henry</h5>
                                            <span>GoFly Traveler</span>
                            ...
                            <div className="swiper-slide">
                                <div className="testimonial-card three">
                                    ...
                                    <div className="author-area">
                                        <div className="author-img">
                                            <img src="/images/testimonial-author-img4.png" alt="" />
                                        </div>
                                        <div className="author-info">
                            ...
                            <div className="swiper-slide">
                                <div className="testimonial-card three">
                                    ...
                                    <p>Our trip to Bali was unforgettable! Everything was perfectly organized by the
                                        agency from start to finish.</p>
                                    <div className="author-area">
                                        <div className="author-img">
                                            <img src="/images/testimonial-author-img5.png" alt="" />
                                        </div>
                                        <div className="author-info">
                                            <h5>Amber Lashley</h5>
                                            <span>GoFly Traveler</span>
            ...
            <div className="row gy-md-5 gy-4">
                <div className="col-lg-3 col-sm-6 divider">
                    ...
                    <svg className="line" width="6" height="215" viewBox="0 0 6 215" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M3.5 5L5.88675 0H0.113249L2.5 5H3.5ZM2.5 210L0.113249 215H5.88675L3.5 210H2.5ZM2.5 4.5V210.5H3.5V4.5H2.5Z">
                        </path>
                    </svg>
                </div>
