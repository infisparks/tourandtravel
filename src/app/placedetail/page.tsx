...
export default function Page() {
        ...
        <div className="swiper destination-details-gallery-slider">
            <div className="swiper-wrapper">
                <div className="swiper-slide">
                    <img src="/images/destination-details-gallery-img1.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                    <img src="/images/destination-details-gallery-img2.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                    <img src="/images/destination-details-gallery-img3.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                    <img src="/images/destination-details-gallery-img4.jpg" alt="" />
                </div>
                <div className="swiper-slide">
                    <img src="/images/destination-details-gallery-img5.jpg" alt="" />
                </div>
            </div>
        </div>
                    ...
                    <div className="swiper destination-dt-location-slider">
                        <div className="swiper-wrapper">
                            ...
                            <div className="swiper-slide">
                                <div className="location-card">
                                    <div className="location-img">
                                        <img src="/images/destination-dt-location-img2.jpg" alt="" />
                                    </div>
                                    <div className="location-content">
                            ...
                            <div className="swiper-slide">
                                <div className="location-card">
                                    <div className="location-img">
                                        <img src="/images/destination-dt-location-img3.jpg" alt="" />
                                        <button className="img-album-btn">
                                            <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path d="M3.93766 8.00088C4.2858 8.00088 4.61969 7.86258 4.86586 7.61641C5.11203 7.37023 5.25033 7.03635 5.25033 6.68821C5.25033 6.34007 5.11203 6.00619 4.86586 5.76002C4.61969 5.51385 4.2858 5.37555 3.93766 5.37555C3.58952 5.37555 3.25564 5.51385 3.00947 5.76002C2.7633 6.00619 2.625 6.34007 2.625 6.68821C2.625 7.03635 2.7633 7.37023 3.00947 7.61641C3.25564 7.86258 3.58952 8.00088 3.93766 8.00088Z"></path>
                                        ...
                                        <div className="image-album-wrap d-none">
                                            <a href="assets/img/innerpages/destination-dt-location-img3.jpg" data-fancybox="images"></a>   
                                            <a href="assets/img/innerpages/destination-dt-location-img2.jpg" data-fancybox="images"></a>   
                                            <a href="assets/img/innerpages/destination-dt-location-img5.jpg" data-fancybox="images"></a>   
                                        </div>
                                    </div>
                                    <div className="location-content">
                            ...
                            <div className="swiper-slide">
                                <div className="location-card">
                                    <div className="location-img">
                                        <img src="/images/destination-dt-location-img4.jpg" alt="" />
                                    </div>
                                    <div className="location-content">
                            ...
                            <div className="swiper-slide">
                                <div className="location-card">
                                    <div className="location-img">
                                        <img src="/images/destination-dt-location-img5.jpg" alt="" />
                                    </div>
                                    <div className="location-content">
                            ...
                            <div className="swiper-slide">
                                <div className="location-card">
                                    <div className="location-img">
                                        <img src="/images/destination-dt-location-img6.jpg" alt="" />
                                        <button className="img-album-btn">
                                            <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path d="M3.93766 8.00088C4.2858 8.00088 4.61969 7.86258 4.86586 7.61641C5.11203 7.37023 5.25033 7.03635 5.25033 6.68821C5.25033 6.34007 5.11203 6.00619 4.86586 5.76002C4.61969 5.51385 4.2858 5.37555 3.93766 5.37555C3.58952 5.37555 3.25564 5.51385 3.00947 5.76002C2.7633 6.00619 2.625 6.34007 2.625 6.68821C2.625 7.03635 2.7633 7.37023 3.00947 7.61641C3.25564 7.86258 3.58952 8.00088 3.93766 8.00088Z"></path>
                                        ...
                                        <div className="image-album-wrap d-none">
                                            <a href="assets/img/innerpages/destination-dt-location-img6.jpg" data-fancybox="images"></a>   
                                            <a href="assets/img/innerpages/destination-dt-location-img1.jpg" data-fancybox="images"></a>   
                                            <a href="assets/img/innerpages/destination-dt-location-img4.jpg" data-fancybox="images"></a>   
                                        </div>
                                    </div>
                                    <div className="location-content">
                            ...
                            <div className="swiper-slide">
                                <div className="location-card">
                                    <div className="location-img">
                                        <img src="/images/destination-dt-location-img7.jpg" alt="" />
                                    </div>
                                    <div className="location-content">
        ...
        <div className="container-fluid">
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="swiper destionation-dt-customer-gallery-slider">
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                <img src="/images/customer-gallery-img1.png" alt="" />
                            </div>
                            <div className="swiper-slide">
                                <img src="/images/customer-gallery-img2.png" alt="" />
                            </div>
                            <div className="swiper-slide">
                                <img src="/images/customer-gallery-img3.png" alt="" />
                            </div>
                            <div className="swiper-slide">
                                <img src="/images/customer-gallery-img4.png" alt="" />
                            </div>
                            <div className="swiper-slide">
                                <div className="video-area">
                                    <video autoPlay loop muted playsInline src="/media/destination-details-video.mp4"></video>
                                </div>
                            </div>
                            <div className="swiper-slide">
                                <img src="/images/customer-gallery-img6.png" alt="" />
                            </div>
                            <div className="swiper-slide">
                                <img src="/images/customer-gallery-img7.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div className="destination-dt-travel-season-section mb-100" id="scroll-section">
        <div className="container">
            <div className="section-title mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            ...
            <div className="row g-4">
                    ...
                    <div className="travel-season-card">
                        <div className="travel-season-top-area">
                            <div className="travel-season-img">
                                <img src="/images/travel-season-img1.jpg" alt="" />
                            </div>
                            <div className="travel-season-content">
                                <h5>Spring (March–May)</h5>
                                <span>Weather: 12–20°C / 53–68°F</span>
                        ...
                        <span className="note">Perfect For: First-time travelers, couples, light packers</span>
                    </div>
                </div>
                <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div className="travel-season-card">
                        <div className="travel-season-top-area">
                            <div className="travel-season-img">
                                <img src="/images/travel-season-img2.jpg" alt="" />
                            </div>
                            <div className="travel-season-content">
                                <h5>Summer (June–August)</h5>
                                <span>Weather: 20–30°C / 68–86°F</span>
                                <div className="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                        ...
                        <span className="note">Perfect For: Festival lovers, families, nightlife explorers</span>
                    </div>
                </div>
                <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="travel-season-card">
                        <div className="travel-season-top-area">
                            <div className="travel-season-img">
                                <img src="/images/travel-season-img3.jpg" alt="" />
                            </div>
                            <div className="travel-season-content">
                                <h5>Autumn (Sep to Nov)</h5>
                                <span>Weather: 0–18°C / 50–64°F</span>
                                <div className="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                        ...
                        <span className="note">Photographers, solo travelers, wine lovers</span>
                    </div>
                </div>
                <div className="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div className="travel-season-card">
                        <div className="travel-season-top-area">
                            <div className="travel-season-img">
                                <img src="/images/travel-season-img4.jpg" alt="" />
                            </div>
                            <div className="travel-season-content">
                                <h5>Winter (Dec to Feb)</h5>
                                <span>Weather: 3–8°C / 37–46°F</span>
                                <div className="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                        ...
                        <span className="note">Budget travelers, romantics, festive moods</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div className="destination-dt-faq-video-area">
        <div className="container">
            <div className="video-wrap">
                <img src="/images/destination-dt-faq-video-img.jpg" alt="" />
                <a data-fancybox="video-player" href="https://www.youtube.com/watch?v=u31qwQUeGuM" className="play-btn">
                            ...
                            <div className="accordion accordion-flush" id="accordionFlushExample">
                                ...
                                <div className="accordion-item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                                    <h5 className="accordion-header" id="flush-headingThree">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree" aria-expanded="false" aria-controls="flush-collapseThree">Can I Book Flights, Hotels, and Tours Separately?</button>
                                    </h5>
                                ...
                                <div className="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                    <h5 className="accordion-header" id="flush-headingFive">
                                        <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFive" aria-expanded="false" aria-controls="flush-collapseFive">What Payment Methods Do You Accept?</button>
                                    </h5>
    ...
    <div className="destination-dt-trip-slider-section mb-100">
        <div className="container">
            <div className="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="col-xl-6 col-lg-8">
                    <div className="section-title text-center">
                        <h2>3 Tours Available in Paris</h2>
                        ...
                        <div className="swiper-wrapper">
                                    ...
                                    <div className="package-content">
                                        ...
                                        <div className="location-and-time">
                                            <div className="location">
                                                ...
                                                <a href="travel-package-01.html">Montmartre</a>
                                            </div>
                            ...
                            <div className="swiper-slide">
                                <div className="package-card">
                                    ...
                                    <div className="package-content">
                                        <h5><a href="travel-package-details.html">Santorini Tour</a></h5>
                                        <div className="location-and-time">
                                            <div className="location">
                                                <svg width="14" height="14" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M6.83615 0C3.77766 0 1.28891 2.48879 1.28891 5.54892C1.28891 7.93837 4.6241 11.8351 6.05811 13.3994C6.25669 13.6175 6.54154 13.7411 6.83615 13.7411C7.13076 13.7411 7.41561 13.6175 7.6142 13.3994C9.04821 11.8351 12.3834 7.93833 12.3834 5.54892C12.3834 2.48879 9.89464 0 6.83615 0ZM7.31469 13.1243C7.18936 13.2594 7.02008 13.3342 6.83615 13.3342C6.65222 13.3342 6.48295 13.2594 6.35761 13.1243C4.95614 11.5959 1.69584 7.79515 1.69584 5.54896C1.69584 2.7134 4.00067 0.406933 6.83615 0.406933C9.67164 0.406933 11.9765 2.7134 11.9765 5.54896C11.9765 7.79515 8.71617 11.5959 7.31469 13.1243Z"></path>
                                                ...
                                                <a href="travel-package-01.html">Latin Quarter</a>
                                            </div>
                                            <svg className="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"></path>
                                            </svg>
                                    ...
                                    <div className="package-content">
                                        ...
                                        <div className="location-and-time">
                                            <div className="location">
                                                ...
                                                <a href="travel-package-01.html">Le Marais</a>
                                            </div>
                                            <svg className="arrow" width="25" height="6" viewBox="0 0 25 6" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0 3L5 5.88675V0.113249L0 3ZM25 3L20 0.113249V5.88675L25 3ZM4.5 3.5H20.5V2.5H4.5V3.5Z"></path>
                                            </svg>
